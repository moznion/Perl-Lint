use strict;
use warnings;
use Perl::Lint::Evaluator::ValuesAndExpressions::ProhibitComplexVersion;
use t::Evaluate::Util qw/fetch_violations/;
use Test::Base::Less;

my $class_name = 'ValuesAndExpressions::ProhibitComplexVersion';
...
our $VERSION = "$Foo::VERSION";
our $VERSION = qq{$Foo::VERSION};

===
--- dscr: configure 'use version' to fail.
--- failures: 1
--- params: {prohibit_complex_version => {forbid_use_version => '1'}}
--- input
use version; our $VERSION = qv('1.2.3');
