use strict;
use warnings;
use Perl::Lint::Evaluator::Modules::ProhibitEvilModules;
...
--- dscr: Providing the description for modules, no regular expressions.
--- failures: 3
--- params: {prohibit_evil_modules => {modules_file => 't/Evaluate/Module/prohibit_evil_modules/modules-no-regular-expressions.txt'}}
--- input
use Evil;
use Fatal qw< open close >;
use Getopt::Std;
...
--- dscr: Providing the description for modules, regular expressions.
--- failures: 3
--- params: {prohibit_evil_modules => {modules_file => 't/Evaluate/Module/prohibit_evil_modules/modules-regular-expressions.txt'}}
--- input
use Evil;
use Fatal qw< open close >;
use Getopt::Std;
